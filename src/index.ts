...
async function main() {
  ...
  // periodic sweep flushes ~/.golems-zikaron/outbox.md to the notify path, and
  // the file-backed monitor deadman registry so this agent's sweep fires any
  // lapsed monitor (surviving the owner's own death) via the notify path.
