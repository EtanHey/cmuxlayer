 ...
 *
 * 41 registered MCP tools with an 11-tool default palette (keep in sync with
 * server.ts and the total-tool-count assertion):
 *   Default (11): spawn_agent, send_to, wait_for, read_screen, my_agents,
 *                 list_agents, broadcast, close_surface, dispatch_to_agent,
 *                 list_surfaces, control_health
