...
export function createServer(opts?: CreateServerOptions): McpServer {
        ...
        try {
          ...
          if (mode !== "agent") {
            ...
            const legacyHandler = (name: string) =>
              registeredTools[name]._cmuxlayerOriginalHandler ??
  ...
  // INTERIM: keep every off-palette capability registered and callable through
  // ToolSearch while the MCP-vs-CLI/programmatic architecture is reconsidered.
  // This is metadata-only and intentionally reversible.
  const registeredTools = (server as any)._registeredTools as Record<
    string,
    {
