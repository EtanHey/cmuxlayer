...
SOURCE_PLIST="$PACKAGE_DIR/launchd/com.golems.cmux-caffeinate.plist"
TARGET_PLIST="$HOME/Library/LaunchAgents/com.golems.cmux-caffeinate.plist"
MODE="${1:---dry-run}"
...
echo "installed com.golems.cmux-caffeinate from $TARGET_PLIST"
