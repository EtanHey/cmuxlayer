...
SOURCE_PLIST="$PACKAGE_DIR/launchd/com.golems.cmux-contract-nightly.plist"
TARGET_PLIST="$HOME/Library/LaunchAgents/com.golems.cmux-contract-nightly.plist"
MODE="${1:---dry-run}"
...
mkdir -p "$(dirname "$TARGET_PLIST")" "$HOME/.local/state/cmux"
...
echo "installed com.golems.cmux-contract-nightly from $TARGET_PLIST"
