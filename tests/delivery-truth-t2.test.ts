...
describe("T2 delivery truth — composer draft safety (#442)", () => {
  ...
  it("lets key Return act on an exact engine-owned Codex queue below quoted scrollback", async () => {
  ...
  it.each([
    ...
    ["duplicates the visible text within a queue block", "queued request", [
      "  ↳ queued request",
      "  ↳ queued request",
    ]],
