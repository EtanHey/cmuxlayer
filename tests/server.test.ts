...
describe("createServer", () => {
  ...
  it("never advertises a Claude channel, even with the removed CMUXLAYER_ENABLE_CLAUDE_CHANNELS=1", () => {
    const previous = process.env.CMUXLAYER_ENABLE_CLAUDE_CHANNELS;
    ...
    try {
      ...
      if (previous === undefined) delete process.env.CMUXLAYER_ENABLE_CLAUDE_CHANNELS;
      else process.env.CMUXLAYER_ENABLE_CLAUDE_CHANNELS = previous;
    }
  });
});
